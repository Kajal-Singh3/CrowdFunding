...
contract CrowdFunding{
   mapping (address => uint) public Contributors;//map address of contributors to the amount contributed
   ...
   struct Request{
       string description;
       address payable recipient;//recepient of money transferred through request.
       uint value;
       bool isCompleted;
       uint noOfVoters;
